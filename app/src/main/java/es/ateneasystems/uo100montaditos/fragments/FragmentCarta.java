package es.ateneasystems.uo100montaditos.fragments;
...
import es.ateneasystems.uo100montaditos.ListView_personalizado.ZTiposDatos;
import es.ateneasystems.uo100montaditos.Clases.ZBaseDatos;
import es.ateneasystems.uo100montaditos.ListView_personalizado.ZTiposAdapter;
import es.ateneasystems.uo100montaditos.ListView_personalizado.ZTiposDatos;
 ...
 */
public class FragmentCarta extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    private ArrayList<ZTiposDatos> listaSorteos = new ArrayList<ZTiposDatos>();
    ...
    public void cargarTarjetas() {
        ...
        recyclerView.setAdapter(new ZTiposAdapter(listaSorteos, R.layout.cardview_item_tipos));
    ...
    public void contenido() {
        ...
        try {
            ...
            for (int i = 0; i < respuestaJSON.length(); i++) {
                Log.e("CANTIDAD", String.valueOf(respuestaJSON.length()));
                Log.e("Entra", String.valueOf(i));
                ...
                //Cadena JSON
                // textoFormateado = "";
                ZTiposDatos dato = new ZTiposDatos();
                dato.setId(i);

                dato.setNombreTipoMontadito(jsonObject.getString("tipo"));
               ...
               Log.e("NUMERO FECHA", jsonObject.getString("tipo"));
